...
describe OpenvoxStrings::Yard::Handlers::Puppet::DefinedTypeHandler do
  ...
  describe 'parsing a defined type with a docstring' do
    ...
    it 'registers a defined type object' do
      ...
      expect(object).to be_a(OpenvoxStrings::Yard::CodeObjects::DefinedType)
      expect(object.namespace).to eq(OpenvoxStrings::Yard::CodeObjects::DefinedTypes.instance)
